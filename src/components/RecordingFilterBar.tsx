  ...
  return (
    ...
    >
      <Grid container direction="column" spacing={2}>
        {filters.map((_, index) => (
          <Grid key={index} container spacing={2} alignItems="center" wrap="wrap">
        ...
        <Grid container spacing={2} sx={{ mt: 1 }} alignItems="center" justifyContent="space-between" wrap="wrap">
          <Grid item xs={12} md="auto">
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ width: { xs: '100%', sm: 'auto' } }}>
              <Button type="button" variant="outlined" color="secondary" startIcon={<AddIcon />} onClick={addFilter} sx={{ fontWeight: 700, width: { xs: '100%', sm: 'auto' } }}>
                Adicionar filtro
              </Button>
